  ...
  try {
    ...
    for (let v = v1; v <= v2; v++) {
      const [r1, r2] = await Promise.all([
        fetch(`https://bolls.life/get-verse/CNV/${bookCode}/${ch}/${v}/`),
